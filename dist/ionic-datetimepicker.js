...
! function(e) {
    ...
    var r = {},
        o = function(e) {
            ...
            angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.showTodayButton) && (u = e.datepickerObject.showTodayButton), 
            angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.callback) && angular.isFunction(e.datepickerObject.callback) && (t = e.datepickerObject.callback), 
            angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.calendarMode) && (k = e.datepickerObject.calendarMode), 
            angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.hideCancelButton) && (f = e.datepickerObject.hideCancelButton), 
            angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.hideSetButton) && (b = e.datepickerObject.hideSetButton), 
            angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.highlights) && angular.isArray(e.datepickerObject.highlights) && (D = e.datepickerObject.highlights),
            {
                mondayFirst: o,
                startYear: n,
                endYear: a,
    ...
    function n(e) {
        var n, a = {};
        return n = angular.isDefined(e.datepickerObject) && angular.isDefined(e.datepickerObject.date) && angular.isDate(e.datepickerObject.date) ? angular.copy(e.datepickerObject.date) : new Date, 
        e.selectedDate = n, 
        e.currentMonth = angular.copy(n), 
        a = t.getParameters(e), 
        e.createDatepicker = function(e) {
            var n = {
                date: e,
    ...
    var r = function(e, r, o) {
        ...
        e.format = e.datepickerObject.format ? e.datepickerObject.format : 24;
        var d = {};
        var s = {
        ...
        e.datepicker.showDatepicker = d.showDatepicker || d.calendarMode, e.datepicker.calendarMode = d.calendarMode, 
        e.datepicker.hideCancelButton = d.hideCancelButton, 
        e.datepicker.hideSetButton = d.hideSetButton,
        e.datepicker.disableTime = d.disableTime,
        e.datepicker.showTodayButton = t.showTodayButton(d), 
        e.sameDate = function(e, n) {
            ...
            e.currentMonth = new Date(e.currentMonth.getFullYear(), t, 1), 
            e.month = e.createDatepicker(e.currentMonth), 
            e.closeModals()
        }, e.selectYear = function(n) {
            e.currentMonth = new Date(n, e.currentMonth.getMonth(), 1), 
            e.selectedYearSlide = t.getActiveYearSlide(e.yearSlides, e.currentMonth.getFullYear()), 
            e.closeYearModal()
            ...
            e.datepicker.showMonthModal = !1, e.datepicker.showYearModal = !1, e.datepicker.showTimeModal = !1
        }, e.closeDateModals = function(){
